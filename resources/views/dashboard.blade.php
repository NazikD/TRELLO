                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                          <h2 class="accordion-header">
                            <button class="accordion-button collapsed bg-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne-{{ $column->id }}" aria-expanded="false" aria-controls="flush-collapseOne-{{ $column->id }}">
                                <div class="add-card" data-column="{{ $column->id }}"
                                    data-value="{{ $column->id }}">Add card</div>
                            </button>
                          </h2>
                          <div id="flush-collapseOne-{{ $column->id }}" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    ...
                                    <div class="card-body-modal">
                                        <p class="card-text">
                                            <input class="task-title" id="create-title" type="text" value="" placeholder="Add Task"
                                                ...
                                                <button class="btn btn-dark create-card" data-value="{{ $column->id }}">Create</button></p>
                                    </div>
                                </div>
                            </div>
                          </div>
